...
The output is `artifacts/ValheimSagas-0.3.7.zip`, with a SHA-256 inventory. The ZIP structure is compatible with Thunderstore and Hexium; uploading is a separate step. Build paths can be supplied explicitly; defaults describe the original development machine.
