...
public sealed partial class SagasPlugin {
 ...
 void SetupLogin(){
  loginShortcut=Config.Bind("Website Login","CopyLoginToken",new KeyboardShortcut(KeyCode.F8,KeyCode.LeftControl),"While playing, generate a personal website login and copy it to your clipboard. Replaces your previous token for this character/world. Never printed or saved locally.");
  revokeShortcut=Config.Bind("Website Login","RevokeLoginToken",new KeyboardShortcut(KeyCode.F9,KeyCode.LeftControl),"While playing, revoke your personal website login for this character/world.");
 }
