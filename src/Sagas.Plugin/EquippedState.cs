...
internal static class EquippedState {
 ...
 internal static void Apply(GearItem gear,ItemDrop.ItemData item,Player player){gear.Equipped=item.m_equipped;JewelcraftingAdapter.JewelrySlot(gear,item,player);gear.Active=IsActive(player,item);}
}
