...
public sealed partial class SagaService : IDisposable {
 ...
 public object State(string world,TimeWindow window,HashSet<string>? selected=null) {
  ...
  foreach(var e in events)if(!shared.Contains(e.PlayerId)||!e.X.HasValue||!e.Z.HasValue||!store.KnownPoint(world,shared,e.X.Value,e.Z.Value)){e.X=null;e.Z=null;}
