...
Inspect(Path.Combine(game,"UnityEngine.CoreModule.dll"),r=>{Method(r,"UnityEngine.Rendering.AsyncGPUReadback","Request","src","mipIndex","dstFormat","callback");Method(r,"UnityEngine.Rendering.AsyncGPUReadbackRequest","GetData","layer");Method(r,"UnityEngine.SystemInfo","get_supportsAsyncGPUReadback");});
