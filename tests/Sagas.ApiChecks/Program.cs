...
Inspect(Path.Combine(game,"assembly_valheim.dll"),r=>{
 ...
 Field(r,"ZNetPeer","m_socket");Signature(r,"ISocket","GetSendQueueSize");TypedField(r,"ZNet","m_ServerName","String");
});
Inspect(Path.Combine(game,"UnityEngine.ImageConversionModule.dll"),r=>Signature(r,"UnityEngine.ImageConversion","EncodeArrayToPNG","System.Array","UnityEngine.Experimental.Rendering.GraphicsFormat","UInt32","UInt32","UInt32"));
Inspect(Path.Combine(game,"assembly_valheim.dll"),r=>{foreach(var name in new[]{"m_modelIndex","m_skinColor","m_hairColor","m_beardItem","m_hairItem","m_leftItem","m_rightItem","m_chestItem","m_legItem","m_helmetItem","m_shoulderItem","m_utilityItem","m_trinketItem","m_leftBackItem","m_rightBackItem"})Field(r,"VisEquipment",name);});
Inspect(Path.Combine(game,"UnityEngine.CoreModule.dll"),r=>{Method(r,"UnityEngine.Rendering.AsyncGPUReadback","Request","src","mipIndex","dstFormat","callback");Method(r,"UnityEngine.Rendering.AsyncGPUReadback","Request","src","mipIndex","x","width","y","height","z","depth","dstFormat","callback");Method(r,"UnityEngine.Rendering.AsyncGPUReadbackRequest","GetData","layer");Method(r,"UnityEngine.SystemInfo","get_supportsAsyncGPUReadback");});
Inspect(Path.Combine(game,"assembly_valheim.dll"),r=>{Method(r,"Humanoid","IsSitting");Method(r,"Player","IsAttached");});
